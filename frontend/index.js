...
document.querySelector('.connectWallet').onclick =  function(e) {
  e.preventDefault(); 
...
// document.querySelector('.logout').onclick = () => { wallet.signOut(); };
...
function signedInFlow() {
  ...
  let wName = document.querySelector('.walletName');
  if (wName) {
    wName.innerHTML = wallet.accountId.substr(0, 10) + "...";
    wName.parentElement.classList.add('logout');
  }
    console.log(wallet)
  // });
}